...
<div class="tw-grid tw-gap-6">
    ...
    <x-ui.data-table title="Select Period" description="Counts show only requisitions and quotations available to your supplier account.">
        <x-slot:toolbar><x-ui.button :href="route('supplier.export.quotations')" variant="secondary" size="sm" data-async-export><x-ui.icon name="file-spreadsheet" /> Export All History</x-ui.button></x-slot:toolbar>
                    ...
                    @forelse($periods as $period)
                        <tr>
                            ...
                            <td class="text-end pe-4">
                                <x-ui.button :href="route('supplier.quotations.period', $period->id)" size="sm">View Requisitions <x-ui.icon name="arrow-right" /></x-ui.button>
                            </td>
                        </tr>
                    @empty
                        <tr>
