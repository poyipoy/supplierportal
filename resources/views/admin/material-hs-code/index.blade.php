        ...
        <div class="tab-content tw-p-4 shell:tw-p-5">
            <div class="tab-pane fade show active" id="materials" role="tabpanel">
                <div class="tw-mb-4 tw-flex tw-flex-col tw-gap-3 xl:tw-flex-row xl:tw-items-end xl:tw-justify-between">
                    ...
                    <x-ui.button type="button" size="sm" id="btnAddMaterial"><x-slot:leading><i class="bi bi-plus-lg"></i></x-slot:leading>Add Material</x-ui.button>
                </div>
            ...
            <div class="tab-pane fade" id="rules" role="tabpanel">
                <div class="tw-mb-4 tw-flex tw-flex-col tw-gap-3 xl:tw-flex-row xl:tw-items-end xl:tw-justify-between">
                    ...
                    <x-ui.button type="button" size="sm" id="btnAddRule"><x-slot:leading><i class="bi bi-plus-lg"></i></x-slot:leading>Add Rule</x-ui.button>
                </div>
                <div class="ui-data-table__scroll tw-overflow-x-auto">
