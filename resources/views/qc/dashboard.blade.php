...
<div class="row g-4 mb-4">
    <div class="col-md-3">
        <div class="card border-0 shadow-sm h-100 border-start border-4 border-primary">
            <div class="card-body"><div class="text-muted small fw-medium mb-1">TOTAL INSPEKSI (BLN INI)</div><h3 class="fw-bold mb-0">{{ $totalInspections }}</h3></div>
        </div>
    </div>
    <div class="col-md-3">
        <div class="card border-0 shadow-sm h-100 border-start border-4 border-success">
            <div class="card-body"><div class="text-muted small fw-medium mb-1">MATERIAL OK</div><h3 class="fw-bold mb-0 text-success">{{ $totalOk }}</h3></div>
        </div>
    </div>
    <div class="col-md-3">
        <div class="card border-0 shadow-sm h-100 border-start border-4 border-danger">
            <div class="card-body"><div class="text-muted small fw-medium mb-1">MATERIAL NG</div><h3 class="fw-bold mb-0 text-danger">{{ $totalNg }}</h3></div>
        </div>
    </div>
    <div class="col-md-3">
...
<div class="row g-4 mb-4">
    <div class="col-lg-4">
        <div class="card border-0 shadow-sm h-100">
            <div class="card-header bg-white py-3"><h6 class="mb-0 fw-bold">Rasio Kualitas (Bulan Ini)</h6></div>
            <div class="card-body d-flex align-items-center justify-content-center">
                @if($totalInspections > 0)
                    <div style="width:220px;height:220px;"><canvas id="qualityChart"></canvas></div>
                @else
                    <div class="text-muted text-center">Belum ada data bulan ini.</div>
                @endif
            </div>
        </div>
    </div>
    <div class="col-lg-8">
        <div class="card border-0 shadow-sm h-100">
            <div class="card-header bg-white py-3"><h6 class="mb-0 fw-bold">Tren OK vs NG (3 Bulan Terakhir)</h6></div>
...
<div class="card border-0 shadow-sm">
    <div class="card-header bg-white py-3 d-flex justify-content-between align-items-center">
        <h6 class="mb-0 fw-bold">Inspeksi Terbaru</h6>
