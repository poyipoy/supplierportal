...
<header class="tw-text-center tw-mb-6">
    ...
    <h2 class="tw-m-0 tw-mt-1.5 tw-text-ui-2xl tw-font-bold tw-tracking-tight tw-text-on-surface">Forgot your password?</h2>
...
<form method="POST" action="{{ route('password.email') }}" class="tw-grid tw-gap-5" novalidate>
    @csrf
    <div class="tw-grid tw-gap-1.5">
        ...
        <div class="tw-relative">
            ...
            <input
                ...
                type="email"
                name="email"
                class="ui-motion tw-h-12 tw-w-full tw-rounded-ui-sm tw-border tw-bg-surface tw-pl-10 tw-pr-3 tw-text-ui-sm tw-text-on-surface focus:tw-border-primary focus:tw-ring-2 focus:tw-ring-primary {{ $errors->has('email') ? 'tw-border-error' : 'tw-border-outline-strong' }}"
