...
class StatusHelperLocalInvoiceToneTest extends TestCase
{
    ...
    {
        $this->assertSame('primary', StatusHelper::localInvoiceTone('SUBMITTED'));
        ...
        $this->assertSame('warning', StatusHelper::localInvoiceTone(LocalInvoice::STATUS_NEED_REVISION));
        ...
        $this->assertSame('info', StatusHelper::localInvoiceTone('PAYMENT_SCHEDULED'));
