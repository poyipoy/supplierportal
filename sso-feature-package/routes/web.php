...
use App\Http\Controllers\Admin\SupplierIdentityProviderController;
...
Route::middleware(['auth', 'role:admin'])->prefix('admin')->name('admin.')->group(function () {
    ...
    // Supplier SSO Connections (SAML/OIDC)
    Route::resource('sso-connections', SupplierIdentityProviderController::class)
        ->parameters(['sso-connections' => 'ssoConnection'])
        ->except(['show']);
    Route::get('/sso-connections/{ssoConnection}/saml-metadata', [SupplierIdentityProviderController::class, 'samlMetadata'])
        ->name('sso-connections.saml-metadata');
    Route::post('/sso-connections/{ssoConnection}/test', [SupplierIdentityProviderController::class, 'testConnection'])
        ->name('sso-connections.test');
});
