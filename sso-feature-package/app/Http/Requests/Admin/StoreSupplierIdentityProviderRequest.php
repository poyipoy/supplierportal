...
class StoreSupplierIdentityProviderRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'domain' => [
                ...
                'unique:supplier_identity_providers,domain',
            ],
            ...
            'saml_idp_x509_cert' => ['required_if:protocol,saml', 'nullable', 'string'],
            ...
            'oidc_client_secret' => ['required_if:protocol,oidc', 'nullable', 'string', 'max:1000'],
        ];
    }

    /**
     * Shape the validated input into the columns/config the model expects.
     *
     * @return array<string, mixed>
     */
    public function validatedConnection(): array
    {
        ...
        return [
            ...
            'config' => $data['protocol'] === SupplierIdentityProvider::PROTOCOL_SAML ? [
                ...
                'idp_x509_cert' => $data['saml_idp_x509_cert'],
            ] : [
