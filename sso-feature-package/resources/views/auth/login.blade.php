...
<div class="tw-mt-5 tw-flex tw-items-center tw-gap-3" role="separator" aria-label="or">
    <span class="tw-h-px tw-flex-1 tw-bg-outline-variant"></span>
    <span class="tw-text-ui-xs tw-font-medium tw-text-on-surface-variant">OR</span>
    <span class="tw-h-px tw-flex-1 tw-bg-outline-variant"></span>
</div>

<a href="{{ route('sso.show') }}" class="ui-focus-ring ui-motion tw-mt-4 tw-flex tw-h-11 tw-w-full tw-items-center tw-justify-center tw-gap-2 tw-rounded-ui-sm tw-border tw-border-outline-variant tw-bg-surface tw-text-ui-sm tw-font-semibold tw-text-on-surface tw-no-underline hover:tw-bg-surface-container">
